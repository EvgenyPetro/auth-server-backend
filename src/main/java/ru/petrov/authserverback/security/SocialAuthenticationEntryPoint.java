...
public final class SocialAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    public SocialAuthenticationEntryPoint(String loginPageUrl, ClientRegistrationRepository clientRegistrationRepository) {
